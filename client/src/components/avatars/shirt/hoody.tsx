...
export default function ShirtHoody(props: { color: string }) {
  const { color } = props
  const lightColor = brightenColor(color, 0.4)
  return (
    <svg
      style={{
        position: 'absolute',
    ...
    >
      ...
      <path
        ...
        strokeWidth='4'
      />
      <path d='M8 84 H271' fill='black' stroke='black' strokeWidth='4' strokeLinejoin='round' />
    </svg>
  )
}
