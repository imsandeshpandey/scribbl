      ...
      <div key='content' className='flex flex-col items-center justify-center gap-2'>
        <div className='relative'>
          <Button
            ...
            size='icon'
            variant='ghost'
            className='absolute right-0 top-0 z-10 cursor-pointer rounded-full bg-background/40 text-foreground hover:bg-emerald-100'
          >
            <DicesIcon />
          </Button>
          <Avatar className='h-40 w-40' {...config} />
        </div>
